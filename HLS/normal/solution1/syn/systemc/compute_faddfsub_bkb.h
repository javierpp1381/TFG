...
#ifndef __compute_faddfsub_bkb__HH__
#define __compute_faddfsub_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_faddfsub_bkb) {
    ...
    SC_CTOR(compute_faddfsub_bkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
