...
código -->|-->visualizer: Funciona bien si le meto .pcd, nada fancy con que funcione vale
          |
          |-->sift keypoints: Extracción de keypoints sift basándose en la estiamción de la normal a la superficie, ver que coño es               |                   cada parámetro
          |
