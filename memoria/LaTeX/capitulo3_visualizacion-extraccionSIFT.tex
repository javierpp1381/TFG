...
\begin{itemize}
\item[•]-r: $radius\_search$, por defecto 0.02
\item[•]-ms: $min\_scale$, por defecto 0.01
\item[•]-no: $n\_octaves$, por defecto 3
\item[•]-ns: $n\_scales\_per\_octave$, por defecto 4
\item[•]-mc: $min\_contrast$, por defecto 0.001
\item[•]-h: help, muestra ayuda por pantalla
\end{itemize}
