...
\\
\includegraphics[scale=0.5]{bunny}
\\
\\
\includegraphics[scale=0.4]{bunny_colored}
\\
...
\\
\includegraphics[scale=0.5]{dragon}
\\
...
\\
\includegraphics[scale=0.5]{angel_lucy}
\\
...
\\
\includegraphics[scale=0.2]{wue_city2}
\\
...
\\
\includegraphics[scale=0.2]{joinedmodel}
\\
...
Una aplicación de la reconstrucción de superficies es la creación de modelos digitales de elevación dentro de la disciplina de sistemas de información geográfica.
