...
//sentence para viento $IIMWV,XX,R,XX.XX,N,A*CR\r\n
//el cacharro de calypso da velocidad y direccion de viento relativa y en nudos (R,N)
struct minmea_sentence_mwv{
	int degrees;
	char reference;
	struct minmea_float windspeed;
	char units;
	char status;
};
...
bool minmea_parse_mwv(struct minmea_sentence_mwv *frame, const char *sentence);
